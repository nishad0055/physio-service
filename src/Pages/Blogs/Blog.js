   ...
   useTitle('Blog')
    return (
        <div className='container mx-auto' >
           <div>
               <h2 className='text-3xl my-5' >Difference between SQL and NoSQL?</h2>
               <h2 className='text-lg font-bold underline' >SQL:</h2>
               ...
               <li>
                ...
                <h2 className='text-lg font-bold underline' >NoSQl</h2>
           ...
           <div className='my-5'>
             <h2 className='text-3xl my-3' >What is JWT, and how does it work?</h2>
           ...
           <div className="my-5">
            <h2 className='text-3xl my-3' >What is the difference between javascript and NodeJS?</h2>
            ...
            <li>	Javascript is capable enough to add HTML and play with the DOM</li>
              <h2 className='my-3 text-lg font-bold' >NodeJs</h2>
           ...
           <div className="my-5">
            <h2 className='text-3xl my-3' >How does NodeJS handle multiple requests at the same time?</h2>
            <p>
            ...
            <h2 className='text-lg' >How Handle Multiple requests</h2>
